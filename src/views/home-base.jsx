	...
	return (
		<Container sx={{textAlign: 'center', mx: 'auto'}}>
			...
			<Image
				sx={{
					mt: 20,
				}} height={isMobile ? 100 : 250} fit='contain'
				src={theme.palette.mode === 'dark' ? darkModeLogo : lightModeLogo}/>
			<br/>

			<Typography variant='body2' sx={{mt: 8}}>Welcome to</Typography>

			<Typography variant='h2' className='heroText'>Dark Launching with React</Typography>

			<Box sx={{py: 2}}/>

			<Typography variant='h4' sx={{mb: 'n1'}}>{user?.username}</Typography>
